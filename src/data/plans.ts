...
const plans: CodingPlan[] = [
  ...
  },
  {
    ...
    highlight: '兼容 Claude Code 等主流编程工具，支持 GLM-5/MiniMax-M2.5/Kimi-K2.5/DeepSeek-V3.2',
    supportedModels: ['GLM-5', 'Kimi-K2.5', 'MiniMax-M2.5', 'DeepSeek-V3.2'],
    startingPrice: '¥40/月',
    priceNum: 40,
    tiers: [
      { name: 'Lite', price: '¥40/月', features: ['1,200 次/5h，9,000 次/周', '每月最多 18,000 次请求', '适配 Claude Code 等 AI 工具'] },
      { name: 'Pro', price: '¥200/月', features: ['6,000 次/5h，45,000 次/周', '每月最多 90,000 次请求', '适配 Claude Code 等 AI 工具'] },
    ],
    updatedAt: '2026-04',
  },
  {
  ...
  },
  {
    ...
    highlight: '仅限 GLM 系列模型，含 GLM-5.1，Lite 套餐不含 GLM-5',
    supportedModels: ['GLM-5.1', 'GLM-5-Turbo', 'GLM-5', 'GLM-4.7', 'GLM-4.6', 'GLM-4.5', 'GLM-4.5-Air'],
    startingPrice: '¥49/月',
    priceNum: 49,
    tiers: [
      { name: 'Lite', price: '¥49/月', features: ['~80 prompts/5h', '~400/周', '~1600/月', '不含 GLM-5'] },
      { name: 'Pro', price: '¥149/月', features: ['~400 prompts/5h', '~2000/周', '~8000/月', '含 GLM-5'] },
      { name: 'Max', price: '¥469/月', features: ['~1600 prompts/5h', '~8000/周', '~32000/月', '含 GLM-5'] },
    ],
    updatedAt: '2026-04',
  },
];
